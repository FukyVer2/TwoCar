...
public class ChartboostAndroid : MonoSingleton<ChartboostAndroid>
{
    ...
    public void RequestInterstitial(CBLocation location)
    {
        Chartboost.cacheInterstitial(location);
    }

    public void RequestRewardedVideo(CBLocation location)
    {
        Chartboost.cacheRewardedVideo(location);
    }

    public void ShowInterstitial(CBLocation location)
    {
        hasInterstitial = Chartboost.hasInterstitial(location);
        if (hasInterstitial)
        {
    ...
    {
        hasRewardedVideo = Chartboost.hasRewardedVideo(location);
        if (hasRewardedVideo)
        {
